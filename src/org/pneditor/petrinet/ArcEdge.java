...
public abstract class ArcEdge extends Edge implements Cloneable {
    ...
    protected void drawConditionLabel(Graphics g, Point arrowTip, String condition) {
        Point labelPoint = getLabelPoint(arrowTip);
        String condStr = "";
        if(!condition.isEmpty())
            condStr = "[" + condition + "]";
        GraphicsTools.drawString(g, condStr, labelPoint.x, labelPoint.y+5, HorizontalAlignment.center, VerticalAlignment.top);
    }
